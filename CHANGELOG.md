...
-   Fixed text visibility issues in VS Code and Cursor for all light themes (#18)
-   Affected themes: Xcode Classic (Light), Xcode Low Key (Light), Xcode Spartan (Light)

### Known Issues

-   Cursor's OpenAI Codex extension may require additional `workbench.colorCustomizations` due to custom UI components that bypass standard theming. See issue #18 for workarounds.
